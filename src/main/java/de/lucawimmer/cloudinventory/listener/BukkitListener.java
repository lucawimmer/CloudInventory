...
public class BukkitListener implements Listener {
    ...
    public void onServerJoined(PlayerJoinEvent e) throws IOException {
        ...
        if(playerQueue.containsKey(e.getPlayer().getName())) {
            // TO PUFFER
            ServerInfo playerinfo = new Gson().fromJson(playerQueue.get(e.getPlayer().getName()), ServerInfo.class);
            ...
            playerQueue.remove(e.getPlayer().getName());
        }
    }
